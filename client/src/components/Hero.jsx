...
const Hero = () => {
    ...
    return (
        <AnimateIn as='section' variant='fadeUpSoft' className='relative min-h-screen flex flex-col items-center justify-center overflow-hidden'>
            ...
            <div className='relative z-10 flex flex-col items-center text-center px-4 md:px-8 mt-16 pb-8 md:pb-0'>
                ...
                {/* Popular city pills */}
                <div className='flex flex-wrap items-center justify-center gap-2 mt-6 mb-8 md:mb-0'>
